...
def elt():
    ...
    try:
        ...
        sql = """
            INSERT INTO analytics.ANAL_STREAMER_GAME_RADER(STEAMER_NM, GAME_NM, AVG_VIEWER_NUM, MAX_VIEWER_NUM, TOTAL_BROADCAST_COUNT, AVG_BROADCAST_DURATION, MAX_BROADCAST_DURATION, MIN_BROADCAST_DURATION, CREATED_DATE)
            SELECT 
                streamer_nm, 
                game_nm, 
