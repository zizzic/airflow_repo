...
if __name__ == "__main__":
    ...
    chat_channel_content=requests.get(f"https://api.chzzk.naver.com/polling/v2/channels/{channel_id[0]}/live-status").json()["content"]
    ...
    # accTkn을 발급받아야한다.
    access_token = requests.get(f"https://comm-api.game.naver.com/nng_main/v1/chats/access-token?channelId={chat_channel_id}&chatType=STREAMING").json()["content"]["accessToken"]
    websocket.enableTrace(False)
    # chating 가져오기
    ws = websocket.WebSocketApp("wss://kr-ss2.chat.naver.com/chat",
